...
module.exports.tests = [
    {
        ...
        async fn() {
            ...
            // A stale compiled .ts fixture would shadow the fresh .js under tsx
            // resolution — remove any leftover before writing.
            fs.rmSync(path.join(jobsDir, 'DrainTestJob.ts'), { force: true });
            fs.writeFileSync(
...
`
            ...
            try {
                ...
                fs.rmSync(path.join(jobsDir, 'DrainTestJob.js'), { force: true });
                fs.rmSync(path.join(jobsDir, 'DrainTestJob.ts'), { force: true });
            }
        },
    },
