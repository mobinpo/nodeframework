...
module.exports.tests = [
    {
        ...
        async fn() {
            ...
            const { setApplication } =
                require('../../vendor/nodevel/framework/src/Database/Eloquent/Model');

            class RelPost extends Model {
                static table: string = 'rel_posts';
                static fillable: string[] = ['title', 'user_id'];
            ...
            class RelComment extends Model {
                static table: string = 'rel_comments';
                static fillable: string[] = ['body', 'rel_post_id'];
                post(): any {
